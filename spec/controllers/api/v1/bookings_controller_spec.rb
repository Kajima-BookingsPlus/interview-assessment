    ...
    context 'when the user is authorized to confirm' do
      ...
      context 'when the booking has been found' do
        ...
        context 'when the correct attributes have been provided' do
          let(:params) { { booking_id: booking.id, send_confirmation_msg: 'true' } }
        ...
        context 'when incorrect attributes have been provided' do
          let(:params) { { booking_id: booking.id, send_confirmation_msg: 'falsee' } }
          let(:expected_response) do
            {
                errors: ['Send confirmation msg is not included in the list']
            }.stringify_keys
          end
